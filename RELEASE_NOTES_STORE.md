# Meca (Cliente) — Release notes for stores
...
- **Payments:** Payments via PagBank (acquirer). Card details are not stored in the app.  
- **Data:** Account and booking data are stored on our servers; the app is the client interface only.
