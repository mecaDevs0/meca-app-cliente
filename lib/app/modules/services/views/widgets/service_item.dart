...
class ServiceItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Substituído GestureDetector por InkWell para feedback visual e melhor resposta tátil
    return Material(
      color: Colors.transparent,
      child: InkWell(
        onTap: onTap,
        // Expandimos a área de toque para todo o card
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Align(
                          ...
                          // Removemos o GestureDetector aninhado que causava conflito
                          child: Row(
